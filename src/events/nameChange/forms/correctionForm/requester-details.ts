...
export const requesterDetailsFields: FieldConfig[] = [
  // B1 - Relationship to person whose name is being changed
  {
    id: 'requester.relationship',
    type: FieldType.TEXT,
    required: true,
    label: {
      id: 'event.nameChange.action.correction.form.section.requester.relationship.label',
      defaultMessage: 'Relationship to person whose name is being changed',
  ...
  // B2 & B3 - Given name(s) and Surname (NAME field type handles both)
  {
    ...
    hideLabel: true,
    label: {
      id: 'event.nameChange.action.correction.form.section.requester.name.label',
      defaultMessage: 'Name',
      description: 'This is the label for the field'
    },
    conditionals: [
  ...
  // B4 - Date of birth (cannot be future date)
  {
    ...
    required: true,
    label: {
      id: 'event.nameChange.action.correction.form.section.requester.dob.label',
    ...
    validation: [
      {
        message: {
          ...
          id: 'event.nameChange.action.correction.form.section.requester.dob.error'
        },
  ...
  // B5 - Nationality (default: Cook Islands)
  {
    ...
    required: true,
    label: {
      id: 'event.nameChange.action.correction.form.section.requester.nationality.label',
  ...
  // B6 - Type of ID
  {
    ...
    label: {
      ...
      description: 'This is the label for the field',
      id: 'event.nameChange.action.correction.form.section.requester.idType.label'
    },
  ...
  // B7 - ID number (Passport)
  {
    ...
    label: {
      ...
      description: 'This is the label for the field',
      id: 'event.nameChange.action.correction.form.section.requester.passport.label'
    },
    conditionals: [
      {
        type: ConditionalType.SHOW,
  ...
  // B7 - ID number (Birth Certificate)
  {
    ...
    label: {
      defaultMessage: 'ID Number',
      description: 'This is the label for the field',
      id: 'event.nameChange.action.correction.form.section.requester.brn.label'
    },
    conditionals: [
      {
        type: ConditionalType.SHOW,
  ...
  // B7 - ID number (Other)
  {
    ...
    label: {
      defaultMessage: 'ID Number',
      description: 'This is the label for the field',
      id: 'event.nameChange.action.correction.form.section.requester.other.label'
    },
    conditionals: [
      {
        type: ConditionalType.SHOW,
