...
export const printCertificateCollectorOther: FieldConfig[] = [
  {
    ...
    label: {
      ...
      description: 'This is the label for the relationship to couple field',
  ...
  },
  {
    ...
    label: {
      ...
      id: 'event.marriageRegistration.action.form.section.collector.other.field.name.label'
    },
    conditionals: [
      {
        type: ConditionalType.SHOW,
  ...
  },
  {
    ...
    label: {
      ...
      id: 'event.marriageRegistration.action.form.section.idType.label'
    },
    conditionals: [
      {
        type: ConditionalType.SHOW,
