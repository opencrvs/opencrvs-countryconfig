...
export const printCertificateCollectorIdentityVerify: FieldConfig[] = [
  {
    id: 'collector.identity.verify.data.brideGroom',
    type: FieldType.DATA,
    conditionals: [
      {
        type: ConditionalType.SHOW,
        conditional: field('collector.requesterId').isEqualTo('BRIDEGROOM')
      }
    ],
    label: {
      defaultMessage: 'Identity details',
      description: 'Title for the data section',
      id: 'event.marriageRegistration.action.certificate.form.section.verifyIdentity.data.label'
    },
    configuration: {
      data: [
  ...
  },
  {
    ...
    conditionals: [
      {
        type: ConditionalType.SHOW,
        conditional: field('collector.requesterId').isEqualTo('BRIDE')
      }
    ],
    label: {
      defaultMessage: 'Identity details',
    ...
    configuration: {
      data: [
        ...
        { fieldId: 'marriageDetails.bridePlaceOfBirth' }
      ]
    }
  },
  {
