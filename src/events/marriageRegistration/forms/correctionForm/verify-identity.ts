...
export const verifyIdentityFields: FieldConfig[] = [
    ...
    conditionals: [
      {
        ...
        conditional: field('requester.type').isEqualTo('BRIDEGROOM')
      }
    ],
    label: {
  ...
  // Verify identity for Bride
  {
    ...
    conditionals: [
      {
        type: ConditionalType.SHOW,
        conditional: field('requester.type').isEqualTo('BRIDE')
      }
    ],
    label: {
      defaultMessage: 'Identity details',
  ...
  // Verify identity for Marriage Officiant
  {
    ...
    conditionals: [
      {
        type: ConditionalType.SHOW,
        conditional: field('requester.type').isEqualTo('MARRIAGE_OFFICIANT')
      }
    ],
    label: {
      defaultMessage: 'Identity details',
