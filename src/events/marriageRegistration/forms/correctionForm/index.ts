...
export const CORRECTION_FORM = defineActionForm({
  label: {
    id: 'event.marriageRegistration.action.correction.form.label',
    defaultMessage: 'Correct record',
    description:
      'This is the label for the marriageRegistration correction form'
  },
  pages: [
    // Page 1 - Correction Request
    {
      ...
      title: {
        id: 'event.marriageRegistration.action.correction.form.section.correctionRequest.title',
    ...
    // Page 2 - ID Validation (Requester's Details)
    {
      ...
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.marriageRegistration.action.correction.form.section.requesterDetails.title',
    ...
    // Page 3a - Verify Their Identity
    {
      ...
      title: {
        id: 'event.marriageRegistration.action.correction.form.section.verifyIdentity.title',
      ...
      actions: {
        verify: {
          label: {
            ...
            id: 'event.marriageRegistration.action.correction.form.verify'
          }
        },
        cancel: {
          label: {
            ...
            id: 'event.marriageRegistration.action.correction.form.cancel'
          },
          confirmation: {
            title: {
              ...
              id: 'event.marriageRegistration.action.correction.form.cancel.confirmation.title'
            },
            body: {
              defaultMessage:
              ...
              id: 'event.marriageRegistration.action.correction.form.cancel.confirmation.body'
            }
          }
        }
      },
      conditional: not(field('requester.type').isEqualTo('SOMEONE_ELSE'))
    },
    // Page 4 - Supporting Documents
    {
      ...
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.marriageRegistration.action.correction.form.section.supportingDocuments.title',
    ...
    // Page 5 - Collect Payment
    {
      ...
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.marriageRegistration.action.correction.form.section.collectPayment.title',
