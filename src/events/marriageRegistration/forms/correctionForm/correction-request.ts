...
const requesterOptions = [
  {
    value: 'BRIDEGROOM',
    label: {
      id: 'event.marriageRegistration.action.correction.form.section.requester.bridegroom.label',
  ...
  },
  {
    value: 'BRIDE',
    label: {
      id: 'event.marriageRegistration.action.correction.form.section.requester.bride.label',
  ...
  },
  {
    value: 'COUPLE',
    label: {
      id: 'event.marriage.action.correction.form.requester.type.couple',
  ...
  },
  {
    ...
    label: {
      id: 'event.marriage.action.correction.form.requester.type.marriageOfficiant',
      defaultMessage: 'Marriage officiant',
      description: 'This is the label for the correction requester field'
    }
  },
  {
    value: 'REGISTRAR',
    label: {
      id: 'event.marriage.action.correction.form.requester.type.registrar',
...
export const correctionRequestFields: FieldConfig[] = [
  ...
  // A2 - Reason for correction
  {
    ...
    required: true,
    label: {
      id: 'event.marriageRegistration.action.correction.form.section.reason.title',
    ...
    options: [
      {
        ...
        label: {
          ...
          id: 'event.marriageRegistration.action.correction.reason.option.clericalError.label'
        }
      },
      {
        ...
        label: {
          ...
          id: 'event.marriageRegistration.action.correction.reason.option.materialError.label'
        }
      },
      {
        ...
        label: {
          ...
          id: 'event.marriageRegistration.action.correction.reason.option.materialOmission.label'
        }
      },
      {
        value: 'OTHER',
        label: {
          ...
          id: 'event.marriageRegistration.action.correction.reason.option.other.label'
        }
      }
    ]
  },
  // A2.1 - Other reason (conditional on A2 = "Other")
  {
    ...
    label: {
      ...
      id: 'event.marriageRegistration.action.correction.reason.other.label'
    },
    conditionals: [
      {
