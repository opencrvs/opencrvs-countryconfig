...
export const collectPaymentFields: FieldConfig[] = [
  // Fee collected
  {
    ...
    label: {
      ...
      id: 'event.marriageRegistration.action.correction.fees.amount.label'
    },
    configuration: {
      min: 0,
      prefix: {
        ...
        id: 'event.marriageRegistration.action.correction.fees.amount.prefix'
      }
    }
  },
  // Receipt number
  {
    ...
    label: {
      ...
      id: 'event.marriageRegistration.action.correction.fees.receiptNumber.label'
    }
  }
]
