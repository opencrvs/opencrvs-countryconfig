  ...
  fields: [
    ...
    // ---- Living status (hidden from hospital clerks) ----
    {
      ...
      conditionals: [
        {
          type: ConditionalType.SHOW,
          conditional: and(fatherDetailsAvailable, hasNonHealthNotifierRole)
        }
      ]
    },
      ...
      configuration: {
        ...
        validation: {
          ...
          message: {
            ...
            description:
              'Error message shown when father birth registration number contains unsupported characters',
            id: 'event.death.action.declare.form.section.father.field.brn.error'
          }
        }
      },
      conditionals: [
    ...
    // ---- Occupation (hidden if deceased) ----
    {
      ...
      conditionals: [
        {
          type: ConditionalType.SHOW,
          conditional: and(fatherDetailsAvailable, notDeceased, hasNonHealthNotifierRole)
        }
      ]
    }
  ]
