...
export const collectPayment = [
      ...
      data: [
        {
          ...
          value: {
            defaultMessage: 'Death certificate issuance',
            description: 'Death certificate issuance service name',
  ...
  },
  {
    ...
    conditionals: [
      {
        type: ConditionalType.SHOW,
        conditional: field('collector.collect.payment.feeWaived').isEqualTo(
          true
        )
      }
    ],
