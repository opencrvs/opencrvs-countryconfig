...
export const CORRECTION_FORM = defineActionForm({
  label: {
    id: 'event.adoption.action.correction.form.label',
    defaultMessage: 'Correct record',
    description: 'This is the label for the adoption correction form'
  },
  pages: [
    // Page 1 - Correction Request
    {
      ...
      title: {
        id: 'event.adoption.action.correction.form.section.correctionRequest.title',
        defaultMessage: 'Correction request',
        description: 'This is the title of the section'
      },
      fields: correctionRequestFields
    },
    // Page 2 - Requester's Details (conditional on requester type = SOMEONE_ELSE)
    {
      id: 'requesterDetails',
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.adoption.action.correction.form.section.requesterDetails.title',
    ...
    // Page 3a - Verify Their Identity
    {
      ...
      title: {
        id: 'event.adoption.action.correction.form.section.verifyIdentity.title',
      ...
      actions: {
        verify: {
          label: {
            ...
            id: 'event.adoption.action.correction.form.verify'
          }
        },
        cancel: {
          label: {
            ...
            id: 'event.adoption.action.correction.form.cancel'
          },
          confirmation: {
            title: {
              ...
              id: 'event.adoption.action.correction.form.cancel.confirmation.title'
            },
            body: {
              defaultMessage:
              ...
              id: 'event.adoption.action.correction.form.cancel.confirmation.body'
            }
          }
        }
      }
    ...
    // Page 4 - Supporting Documents
    {
      ...
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.adoption.action.correction.form.section.supportingDocuments.title',
    ...
    // Page 5 - Collect Payment
    {
      ...
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.adoption.action.correction.form.section.collectPayment.title',
