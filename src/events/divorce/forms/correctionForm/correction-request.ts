...
const requesterOptions = [
  {
    value: 'HUSBAND',
    label: {
      id: 'event.divorce.action.correction.form.section.requester.husband.label',
  ...
  },
  {
    value: 'WIFE',
    label: {
      id: 'event.divorce.action.correction.form.section.requester.wife.label',
      defaultMessage: 'Wife',
      description: 'This is the label for the field'
    }
  },
  {
    value: 'REGISTRAR',
    label: {
      id: 'event.divorce.action.correction.form.requester.type.registrar',
