...
export const CORRECTION_FORM = defineActionForm({
  ...
  pages: [
    // Page 1 - Correction Request
    {
      ...
      title: {
        id: 'event.divorce.action.correction.form.section.correctionRequest.title',
    ...
    // Page 2 - ID Validation (Requester's Details)
    {
      ...
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.divorce.action.correction.form.section.requesterDetails.title',
    ...
    // Page 3a - Verify Their Identity
    {
      ...
      title: {
        id: 'event.divorce.action.correction.form.section.verifyIdentity.title',
    ...
    // Page 4 - Supporting Documents
    {
      ...
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.divorce.action.correction.form.section.supportingDocuments.title',
    ...
    // Page 5 - Collect Payment
    {
      ...
      type: PageTypes.enum.FORM,
      title: {
        id: 'event.divorce.action.correction.form.section.collectPayment.title',
