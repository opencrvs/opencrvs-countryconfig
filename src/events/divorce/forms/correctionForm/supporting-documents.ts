    ...
    options: [
      {
        ...
        label: {
          ...
          id: 'event.divorce.action.correction.documents.supportingDocs.proofOfBridegroomIdentity.label'
        }
      },
      {
        ...
        label: {
          ...
          id: 'event.divorce.action.correction.documents.supportingDocs.proofOfBrideIdentity.label'
        }
      },
      {
        value: 'PARTICULARS_OF_MARRIAGE_FOR_REGISTRATION',
        label: {
          defaultMessage: 'Particulars of marriage for registration',
          description:
            'Label for the particulars of marriage for registration option',
          id: 'event.divorce.action.correction.documents.supportingDocs.particularsOfMarriageForRegistration.label'
        }
      },
      {
        value: 'DEGREE_ABSOLUTE_OR_FINAL_DIVORCE_ORDER',
        label: {
          defaultMessage: 'Degree absolute / final divorce order',
          description:
            'Label for the degree absolute or final divorce order option',
          id: 'event.divorce.action.correction.documents.supportingDocs.degreeAbsoluteOrFinalDivorceOrder.label'
        }
      },
      {
        ...
        label: {
          ...
          id: 'event.divorce.action.correction.documents.supportingDocs.statutoryDeclaration.label'
        }
      },
      {
        ...
        label: {
          ...
          id: 'event.divorce.action.correction.documents.supportingDocs.registrarGeneralAuthorisation.label'
        }
      },
      {
        value: 'OTHER',
