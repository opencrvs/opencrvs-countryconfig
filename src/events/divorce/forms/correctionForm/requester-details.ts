...
export const requesterDetailsFields: FieldConfig[] = [
  // B1 - Relationship to child
  {
    ...
    required: true,
    label: {
      id: 'event.divorce.action.form.section.relationshipToDivorcingParty.label',
  ...
  // B4 - Date of birth (cannot be future date)
  {
    ...
    required: true,
    label: {
      id: 'event.divorce.action.correction.form.section.requester.dob.label',
    ...
    validation: [
      {
        message: {
          ...
          id: 'event.divorce.action.correction.form.section.requester.dob.error'
        },
  ...
  // B5 - Nationality (default: Cook Islands)
  {
    ...
    required: true,
    label: {
      id: 'event.divorce.action.correction.form.section.requester.nationality.label',
  ...
  // B7 - ID number (Birth Certificate)
  {
    ...
    label: {
      defaultMessage: 'ID Number',
      description: 'This is the label for the field',
      id: 'event.divorce.action.correction.form.section.requester.brn.label'
    },
    conditionals: [
      {
        type: ConditionalType.SHOW,
  ...
  // B7 - ID number (Other)
  {
    ...
    label: {
      defaultMessage: 'ID Number',
      description: 'This is the label for the field',
      id: 'event.divorce.action.correction.form.section.requester.other.label'
    },
    conditionals: [
      {
        type: ConditionalType.SHOW,
