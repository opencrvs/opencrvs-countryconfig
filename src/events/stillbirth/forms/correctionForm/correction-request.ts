...
const requesterTypeOptions = [
  {
    value: 'MOTHER',
    label: {
      id: 'event.stillbirth.action.correction.form.requester.type.mother',
  ...
  },
  {
    value: 'FATHER',
    label: {
      id: 'event.stillbirth.action.correction.form.requester.type.father',
      defaultMessage: 'Father',
      description: 'This is the label for the correction requester field'
    }
  },
  {
    value: 'RECORD_SUBJECT',
    label: {
      id: 'event.stillbirth.action.correction.form.requester.type.recordSubject',
  ...
  },
  {
    value: 'REGISTRAR',
    label: {
      id: 'event.stillbirth.action.correction.form.requester.type.registrar',
  ...
  },
  {
    value: 'COURT',
    label: {
      id: 'event.stillbirth.action.correction.form.requester.type.court',
  ...
  },
  {
    value: 'SOMEONE_ELSE',
    label: {
      id: 'event.stillbirth.action.correction.form.requester.type.someoneElse',
...
export const correctionRequestFields: FieldConfig[] = [
  {
    ...
    label: {
      ...
      id: 'event.stillbirth.action.correction.form.section.requester.label'
    },
  ...
  },
  {
    ...
    required: true,
    label: {
      id: 'event.stillbirth.action.correction.form.section.reason.title',
    ...
    options: [
      {
        ...
        label: {
          ...
          id: 'event.stillbirth.action.correction.reason.option.clericalError.label'
        }
      },
      {
        ...
        label: {
          ...
          id: 'event.stillbirth.action.correction.reason.option.materialError.label'
        }
      },
      {
        ...
        label: {
          ...
          id: 'event.stillbirth.action.correction.reason.option.materialOmission.label'
        }
      },
      {
        ...
        label: {
          ...
          id: 'event.stillbirth.action.correction.reason.option.judicialOrder.label'
        }
      },
      {
        value: 'OTHER',
        label: {
          ...
          id: 'event.stillbirth.action.correction.reason.option.other.label'
        }
      }
    ]
  },
  {
    ...
    label: {
      ...
      id: 'event.stillbirth.action.correction.reason.other.label'
    },
    conditionals: [
      {
