...
export const roles: Role[] = [
  ...
  },
  {
    ...
    scopes: defineScopes([
      ...
      { type: 'user.read' },
      { type: 'user.search' },
      { type: 'workqueue', options: { ids: ['assigned-to-you', 'recent', 'requires-completion', 'escalated', 'potential-duplicate', 'pending-validation', 'pending-updates', 'pending-approval', 'pending-registration', 'pending-certification', 'pending-issuance', 'correction-requested', 'registered-births-last-12-months', 'registered-deaths-last-12-months'] } },
      { type: 'record.search' },
      { type: 'record.create' },
      { type: 'record.read' },
      { type: 'record.declare' },
      ...
      { type: 'record.review-duplicates' },
      { type: 'record.unassign-others' },
      { type: 'record.print-certified-copies', options: { event: ['birth', 'death'] } },
      { type: 'record.correct' },
