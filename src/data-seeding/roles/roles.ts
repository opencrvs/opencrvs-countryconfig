...
export const roles: Role[] = [
  ...
  },
  {
    ...
    scopes: defineScopes([
      ...
      { type: 'user.read' },
      { type: 'user.search' },
      { type: 'workqueue', options: { ids: ['assigned-to-you', 'recent', 'requires-completion', 'escalated', 'potential-duplicate', 'pending-validation', 'pending-updates', 'pending-approval', 'pending-registration', 'pending-certification', 'pending-issuance', 'correction-requested', 'registered-births-last-12-months', 'registered-deaths-last-12-months', 'registered-adoptions-last-12-months', 'registered-divorces-last-12-months', 'registered-marriage-registrations-last-12-months', 'registered-name-changes-last-12-months'] } },
      { type: 'record.search' },
      { type: 'record.create' },
      { type: 'record.read' },
      { type: 'record.declare' },
      ...
      { type: 'record.review-duplicates' },
      { type: 'record.unassign-others' },
      { type: 'record.print-certified-copies', options: { event: ['birth', 'death', 'divorce', 'marriage-registration', 'name-change'] } },
      { type: 'record.correct' },
  ...
  },
  {
    ...
    scopes: defineScopes([
      ...
      { type: 'user.read' },
      { type: 'user.search' },
      { type: 'workqueue', options: { ids: ['assigned-to-you', 'recent', 'requires-completion', 'in-external-validation', 'escalated', 'pending-validation', 'pending-updates', 'pending-approval', 'pending-registration', 'pending-certification', 'pending-issuance', 'correction-requested', 'registered-births-last-12-months', 'registered-deaths-last-12-months', 'registered-adoptions-last-12-months', 'registered-divorces-last-12-months', 'registered-marriage-registrations-last-12-months', 'registered-name-changes-last-12-months'] } },
      { type: 'record.search' },
      { type: 'record.create' },
      { type: 'record.read' },
      { type: 'record.edit' },
