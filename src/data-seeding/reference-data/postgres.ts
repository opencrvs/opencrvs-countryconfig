...
import { REFERENCE_DATA_DATABASE_URL } from '@countryconfig/constants'
...
export const getPool = (connectionString = REFERENCE_DATA_DATABASE_URL) => {
  if (!pool) {
...
export function getClient() {
  ...
  return db.withSchema('reference_data')
}