...
export const InformantTemplateType = {
  ...
  birthApprovalNotification: 'birthApprovalNotification',
  birthRevocationNotification: 'birthRevocationNotification',
  birthReinstateNotification: 'birthReinstateNotification',
