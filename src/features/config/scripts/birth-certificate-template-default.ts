...
<path d="M138.429 511.629H281.571" stroke="#EEEEEE" stroke-width="1.22857" stroke-linecap="square" stroke-linejoin="round" />
...
<text fill="#35495D" xml:space="default" style="white-space: pre" font-family="Noto Sans Bengali" font-size="8" font-weight="300" letter-spacing="0px">
...
<text fill="#222222" xml:space="default" style="white-space: pre" font-family="Noto Sans" font-size="10" font-weight="300" letter-spacing="0px">
  <tspan x="50%" y="287.69" text-anchor="middle">Was born on&#10;</tspan>
</text>
<text fill="#222222" xml:space="default" style="white-space: pre" font-family="Noto Sans" font-size="10" font-weight="300" letter-spacing="0px">
  <tspan x="50%" y="345.69" text-anchor="middle">Place of birth&#10;</tspan>
</text>
<text fill="#222222" xml:space="default" style="white-space: pre" font-family="Noto Sans Bengali" font-size="12" font-weight="500" letter-spacing="0px">
...
<text fill="#222222" xml:space="default" style="white-space: pre" font-family="Noto Sans" font-size="12" letter-spacing="0px">
  <tspan x="50%" y="127.828" text-anchor="middle">Birth Registration No&#10;</tspan>
</text>
<text fill="#222222" xml:space="default" style="white-space: pre" font-family="Noto Sans" font-size="8" letter-spacing="0px">
...
<text fill="#222222" xml:space="default" style="white-space: pre" font-family="Noto Sans" font-size="4.34258" font-weight="800" letter-spacing="0.2em">
  <tspan x="191.848" y="84.9903">FARAJALAND</tspan>
</text>
<mask id="mask0_925_20" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="140" y="461" width="140" height="45">
  <rect x="140" y="461.257" width="140" height="44" fill="#FCC7C7" />
</mask>
<g mask="url(#mask0_925_20)">
  <rect x="145.558" y="461.257" width="129.116" height="45.2572" fill="url(#pattern0)" />
</g>
<defs>
  <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image0_925_20" transform="scale(0.000818331 0.00224215)" />
  </pattern>
  <image id="image0_925_20" width="1222" height="446" data-content="signature" xlink:href="{{registrarSignature}}" />
</defs>
</svg>`
