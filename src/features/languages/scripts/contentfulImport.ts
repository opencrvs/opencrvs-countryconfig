...
import { LANGUAGES_SOURCE } from '@countryconfig/constants'
import * as Contentful from 'contentful'
import {
  SUPPORTED_LOCALES,
  SPACE_ID,
  USER_ID
} from '@countryconfig/features/languages/scripts/constants'
import { contentfulTemplate } from '@countryconfig/features/languages/scripts/contentful-template'
